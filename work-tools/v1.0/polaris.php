...
<html lang="en">
  <head>
    ...
    <title>Polaris  || Creation Tool [4] InterMark || AbdElRahmanAhmad.com</title>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="panel panel-danger">
            <div class="panel-heading"><h3 class="panel-title">Polaris Creation</h3></div>
            <div class="panel-body">
              <form action="process_polaris.php" method="post">
                <div class="row">
