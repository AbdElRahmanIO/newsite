...
<html lang="en">
  <head>
    ...
    <title>IRep || Creation Tool [4] InterMark || AbdElRahmanAhmad.com</title>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="panel panel-danger">
            <div class="panel-heading"><h3 class="panel-title">IRep Creation</h3></div>
            <div class="panel-body">
              <form action="process_veeva_irep.php" method="post">
                <div class="row">
                  ...
                  <div class="form-group col-sm-12">
                    ...
                    <input type="text" class="form-control" id="inputimages" Name="inputimages" placeholder="" value="inputs/bg2/" required>
                  </div>

                  <div class="form-group col-sm-12">
                    <label for="inputimagesthumbs">مسار الصمب (thumbs)</label>
                    <input type="text" class="form-control" id="inputimagesthumbs" Name="inputimagesthumbs" placeholder="" value="inputs/thumbs2/">
                  </div>
