...
<html lang="en">
  <head>
    ...
    <title>MI || Creation Tool [4] InterMark || AbdElRahmanAhmad.com</title>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="panel panel-danger">
            <div class="panel-heading"><h3 class="panel-title">MI Creation</h3></div>
            <div class="panel-body">
              <form action="process_mi.php" method="post">
                <div class="row">
